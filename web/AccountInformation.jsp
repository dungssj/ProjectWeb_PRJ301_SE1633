<%-- 
    ...
    Created on : Jul 5, 2022, 10:06:25 AM
    Author     : Dung
--%>
                        ...
                        <div class="d-flex align-items-start h-100 ">
                                ...
                                <div class="col-md-9 content-container py-4 px-5 h-100">
                                        ...
                                        <div class="row my-4">
                                            ...
                                            <div class="col-6 mb-3">
                                                <label>Gender</label>
                                                <input type="text" name="Gender" value="${user.isGender()}" class="form-control">
                                            </div>
                                            <div class="col-6 mb-3">
                                        ...
                                        <button class="btn btn-success" type="button"><a href="AccountSetting.jsp" style="text-decoration: none; color: white;">Edit Information</a></button>
                                </div>
                          </div>
                    </div>
                </div>
